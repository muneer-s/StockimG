...
const Header = () => {
  ...
  return (
    <header className={`bg-gradient-to-r from-rose-50 via-white to-rose-50 backdrop-blur-md shadow-lg border-b border-rose-100 fixed top-0 left-0 right-0 z-50 transition-transform duration-300 ease-in-out ${
